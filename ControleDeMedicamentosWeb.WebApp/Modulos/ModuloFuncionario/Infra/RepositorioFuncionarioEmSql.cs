...
public sealed class RepositorioFuncionarioEmSql(ISqlConnectionFactory connectionFactory) : IRepositorioFuncionario
{
    ...
    public Funcionario? SelecionarPorId(Guid idSelecionado)
    {
        ...
        return conexao.QuerySingleOrDefault<Funcionario>(SelecionarPorIdSql, new { Id = idSelecionado });
    }
